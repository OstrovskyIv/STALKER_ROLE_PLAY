...
<template>
  <nav class="fixed top-36 sm:top-44 md:top-8 left-0 w-full z-30 flex justify-center px-4 pointer-events-none font-capture">
    <div class="flex items-center gap-3 sm:gap-6 xl:gap-10 px-6 sm:px-10 py-2 sm:py-3 xl:py-4 bg-zinc-950/90 border border-white/80 shadow-[0_0_20px_rgba(255,255,255,0.4)] rounded-full pointer-events-auto">
