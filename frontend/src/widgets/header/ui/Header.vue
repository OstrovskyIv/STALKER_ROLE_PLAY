...
<template>
  <header class="fixed top-0 left-0 w-full z-[100] pointer-events-none transition-all duration-700">
    <div
      :class="[
        'w-full flex flex-col 2xl:flex-row items-center justify-center 2xl:justify-between px-6 2xl:px-16 transition-all duration-700 relative',
    ...
    >
      ...
      >
        <img
          :src="logoSvg"
          alt="Last Zone"
          class="h-[65px] sm:h-[90px] md:h-[110px] 2xl:h-[130px] w-auto drop-shadow-[0_0_35px_rgba(255,255,255,0.15)]"
        />
      </div>
