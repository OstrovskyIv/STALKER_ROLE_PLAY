...
<template>
  ...
  >
    <div class="flex justify-center w-full xl:w-auto pt-4 md:pt-6">
      <img
        :src="logoImg"
      class="h-[115px] sm:h-32 md:h-40 xl:h-48 w-auto drop-shadow-[0_0_30px_rgba(255,255,255,0.15)] pointer-events-auto transition-all"
      alt="Last Zone"
      />
    </div>
  </header>
